...
const Dashboard : React.FC= () => {
 ...
 const handleInputChange =(event : React.ChangeEvent<HTMLInputElement>)=>{
  ...
  useEffect(()=>{
    ...
    appClient.get('latestEmployeeActivity/').then(
      res=>{       
      ...
      <div className="dashBoardcol1">
        ...
        >
          ...
          <div className="e-card-header-title employeeActivities">
            <span style={{fontSize:`20px`}}><b>Todays Employee Activity</b></span>
          ...
          >           
              ...
              <div style={{                   
                    ...
                    flexDirection: `row`,                    
                      ...
                      <div style={{padding : `8px`}}> <span style={{fontSize:`14px`}}><b>IP Address </b></span> <p>103.215.154.12</p></div>    
                      <div style={{padding : `8px`}}><span style={{fontSize:`14px`}}><b>Current Date</b></span> <p>{todayDate}</p></div>         
              </div>            
              <div className="dateTime">
                  <div><span style={{fontSize:`14px`}}><b>Current Time </b></span> </div> 
              <div>{<DateTime/>}</div>
              </div>           
              ...
              <div className="e-card-header-title"><span style={{fontSize:`20px`}}><b>Attendance</b></span> </div>
